...
// more-details end
$("body").append('<div class="fixed-button active"><a href="backoffice/property/new" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> New Property</a> </div>');
